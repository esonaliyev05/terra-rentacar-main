  ...
  return (
    <section className="container mx-auto px-[20px] pt-[30px] pb-[60px]">
      <div>
        ...
        <h1 className="text-[#FFF] text-3xl pt-10 pl-6 font-sans">
        ...
        <div>
          <div className="container">
            <a className="  mt-8 flex flex-col md:gap-[20px] shadow-sm md:flex-row p-[20px] items-center bg-[#272933]">
              ...
              <div className="flex flex-col justify-between mt-[20px] md:mt-0  leading-normal">
                <h5 className=" text-[24px]   lg:text-[36px] font-medium tracking-tight text-white">
                  {translations[language]?.topCarsBlog ||
                    translations?.en?.topCarsBlog}
                </h5>
                <p className="mb-3 text-[16px] mt-[10px] md:mt-0 lg:text-[20px] font-normal text-white max-w-6xl">
                  {translations[language]?.topCarsBlog1 ||
                    translations?.en?.topCarsBlog1}
                </p>
                <div className="flex items-end justify-between">
                  <p className="text-white pt-7">
                    {" "}
                    {translations[language]?.topCarsBlog2 ||
                      translations?.en?.topCarsBlog2}
                  </p>
            ...
            <a className="  mt-8 flex flex-col md:gap-[20px]  shadow-sm md:flex-row p-[20px] items-center bg-[#272933]">
              ...
              <div className="flex flex-col justify-between mt-[20px] md:mt-0  leading-normal">
                <h5 className="text-[24px] lg:text-[36px] font-medium tracking-tight text-white">
                  {translations[language]?.topCarsBlog3 ||
                    translations?.en?.topCarsBlog3}
                </h5>
                <p className="mb-3 text-[16px] mt-[10px] md:mt-0 lg:text-[20px] font-normal text-white max-w-6xl">
                  {translations[language]?.topCarsBlog4 ||
                    translations?.en?.topCarsBlog4}
                </p>
                <div className="flex items-end justify-between">
                  <p className="text-white pt-7">
                    {translations[language]?.topCarsBlog5 ||
                      translations?.en?.topCarsBlog5}
                  </p>
            ...
            <a className="mt-8 flex flex-col md:gap-[20px]  shadow-sm md:flex-row p-[20px] items-center bg-[#272933]">
              ...
              <div className="flex flex-col justify-between mt-[20px] md:mt-0  leading-normal">
                <h5 className="text-[24px]   lg:text-[36px] font-medium tracking-tight text-white">
                  {translations[language]?.topCarsBlog6 ||
                    translations?.en?.topCarsBlog6}
                </h5>
                <p className="mb-3 text-[16px] lg:text-[20px] font-normal text-white max-w-6xl mt-[10px] md:mt-0">
                  {translations[language]?.topCarsBlog7 ||
                    translations?.en?.topCarsBlog7}
                </p>
                <div className="flex items-end justify-between">
                  <p className="text-white pt-7">
                    {" "}
                    {translations[language]?.topCarsBlog8 ||
                      translations?.en?.topCarsBlog8}
                  </p>
